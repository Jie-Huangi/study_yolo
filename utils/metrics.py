...
def fitness(x):
    """Calculates fitness of a models using weighted sum of metrics P, R, mAP@0.5, mAP@0.5:0.95."""
...
def bbox_iou(box1, box2, xywh=True, GIoU=False, DIoU=False,
             CIoU=False, EIoU=False, SIoU=False, WIoU=False,
             ShapeIoU=False, hw=1, mpdiou=False,
             eps=1e-7, scale=0.0
             ):
    """
...
def plot_mc_curve(px, py, save_dir=Path("mc_curve.png"), names=(), xlabel="Confidence", ylabel="Metric"):
    """Plots a metric-confidence curve for models predictions, supporting per-class visualization and smoothing."""
    fig, ax = plt.subplots(1, 1, figsize=(9, 6), tight_layout=True)
