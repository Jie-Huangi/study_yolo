...
class LoadImagesAndLabels(Dataset):
    ...
    def __init__(
        ...
        try:
            ...
            cache, exists = self.cache_labels(cache_path, prefix), False  # runs cache ops
    ...
    def collate_fn4(batch):
        """Bundles a batch's data by quartering the number of shapes and paths, preparing it for models input."""
        im, label, path, shapes = zip(*batch)  # transposed
        n = len(shapes) // 4
