...
set_logging(LOGGING_NAME)  # runs before defining LOGGER
...
def check_amp(model):
    """Checks PyTorch AMP functionality for a models, returns True if AMP operates correctly, otherwise False."""
