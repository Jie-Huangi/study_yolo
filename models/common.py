...
class SPPF(nn.Module):
    ...
    def __init__(self, c1, c2, k=5):
        """
        Initializes YOLOv5 SPPF layer with given channels and kernel size for YOLOv5 models, combining convolution and
        max pooling.
...
class DetectMultiBackend(nn.Module):
    ...
    def warmup(self, imgsz=(1, 3, 640, 640)):
        """Performs a single inference warmup to initialize models weights, accepting an `imgsz` tuple for image size."""
    ...
    def _model_type(p="path/to/models.pt"):
        """
        Determines models type from file path or URL, supporting various export formats.

        Example: path='path/to/models.onnx' -> type=onnx
        """
...
class AutoShape(nn.Module):
    ...
    def __init__(self, model, verbose=True):
        """Initializes YOLOv5 models for inference, setting up attributes and preparing models for evaluation."""
        super().__init__()
        if verbose:
    ...
    def _apply(self, fn):
        ...
        to models tensors excluding parameters or registered buffers.
        """
...
class Detections:
    ...
    def _run(self, pprint=False, show=False, save=False, crop=False, render=False, labels=True, save_dir=Path("")):
        """Executes models predictions, displaying and/or saving outputs with optional crops and labels."""
        s, crops = "", []
    ...
    def __str__(self):
        """Returns a string representation of the models's results, suitable for printing, overrides default
        print(results).
        """
